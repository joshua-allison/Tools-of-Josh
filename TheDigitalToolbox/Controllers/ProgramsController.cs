...
namespace TheDigitalToolbox.Controllers
{
    public class ProgramsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProgramId,Language,Creator,Title,Description,ShareURL")] Models.Program program)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProgramId,Language,Creator,Title,Description,ShareURL")] Models.Program program)
        {
