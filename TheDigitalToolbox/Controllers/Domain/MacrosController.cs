...
namespace TheDigitalToolbox.Controllers
{
    public class MacrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MacroId,App,Creator,Title,Description,ShareURL")] Macro macro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MacroId,App,Creator,Title,Description,ShareURL")] Macro macro)
        {
            if (id != macro.MacroId)
            {
                return NotFound();
        ...
        {
            return _context.Macros.Any(e => e.MacroId == id);
        }
    }
}
