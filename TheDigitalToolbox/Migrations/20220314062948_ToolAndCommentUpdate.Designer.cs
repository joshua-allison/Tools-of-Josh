...
namespace TheDigitalToolbox.Migrations
{
    ...
    [Migration("20220314062948_ToolAndCommentUpdate")]
    partial class ToolAndCommentUpdate
    {
            ...
            modelBuilder.Entity("TheDigitalToolbox.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommentId = 1,
                            Date = new DateTime(2022, 3, 13, 23, 29, 47, 349, DateTimeKind.Local).AddTicks(6040),
