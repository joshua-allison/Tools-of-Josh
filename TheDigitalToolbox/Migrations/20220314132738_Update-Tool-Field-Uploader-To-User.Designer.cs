...
namespace TheDigitalToolbox.Migrations
{
    ...
    [Migration("20220314132738_Update-Tool-Field-Uploader-To-User")]
    partial class UpdateToolFieldUploaderToUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheDigitalToolbox.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommentId = 1,
                            Date = new DateTime(2022, 3, 14, 6, 27, 38, 76, DateTimeKind.Local).AddTicks(6392),
            ...
            modelBuilder.Entity("TheDigitalToolbox.Models.Tool", b =>
                {
                    b.HasOne("TheDigitalToolbox.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
